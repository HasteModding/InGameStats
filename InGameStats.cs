...
public class InGameStats : MonoBehaviour {
    ...
    private string GetStatValue(StatType stat) {
        ...
        return stat switch {
            ...
            StatType.DistanceTravelled => InGameStatsUtils.GetTotalDistance().ToString("F1"),
            StatType.GroundDistanceTravelled => InGameStatsUtils.GetGroundDistance().ToString("F1"),
            StatType.AirDistanceTravelled => InGameStatsUtils.GetAirDistance().ToString("F1"),
